...
function UVIndex(ln, lt) {
  var uvQuery = "https://api.openweathermap.org/data/2.5/uvi?appid=" + APIKey + "&lat=" + lt + "&lon=" + ln;
  $.ajax({
    url: uvQuery,
    method: "GET"
  }).then(function (response) {
...
function forecast(cityid) {
  var forecastQuery = "https://api.openweathermap.org/data/2.5/forecast?id=" + cityid + "&appid=" + APIKey;
  $.ajax({
    url: forecastQuery,
    method: "GET"
  }).then(function (response) {
